  ...
  <div class="h-screen flex flex-col bg-gray-50 dark:bg-gray-950">
    ...
    <header v-if="showNavbar" class="h-12 shrink-0 flex items-center justify-between px-4 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950">
      <div class="flex items-center gap-2.5">
        ...
        <span class="text-xl font-semibold text-gray-900 dark:text-white">全时在线的调解专家</span>
        <span class="text-xs text-gray-400 dark:text-gray-500 font-mono ml-2">Always Online Mediation Expert</span>

...
## 平台背景
本平台服务于向广州仲裁委员会提起仲裁申请的商事纠纷案件。依据《广州仲裁委员会仲裁规则》第19条第4款，本会在收到仲裁申请后，可以根据纠纷的实际情况引导当事人通过其他争议解决方式解决争议。本平台在仲裁案件正式立案前，通过调解方式化解纠纷，引导当事人选择最优解决路径。
...
## 调解结果出口（在适当阶段告知当事人）
当对话进入后期且当事人表现出和解意愿时，可适时告知以下路径：
1. 调解成功 → 撤回仲裁申请：仲裁费用可退回（受理前全额退回，受理后组庭前退回全部受理费+50%处理费）
2. 调解达成协议 → 调解+仲裁：由仲裁庭出具调解书，仲裁费用按50%收取
3. 调解未果 → 继续正式仲裁程序
